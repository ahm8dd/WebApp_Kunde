...
// Importiert das Layout, das eine Ebene höher liegt
import Layout from '../Layout.jsx';

// Importiert alle Seiten (relativ zum src-Ordner)
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/TyreStock" element={<Layout currentPageName="TyreStock"><TyreStock /></Layout>} />
        ...
        <Route path="/Impressum" element={<Layout currentPageName="Impressum"><Impressum /></Layout>} />
        <Route path="/Datenschutz" element={<Layout currentPageName="Datenschutz"><Datenschutz /></Layout>} />
        
        {/* Admin Route */}
        <Route path="/admin/bookings" element={<Layout currentPageName="AdminBookings"><AdminBookings /></Layout>} />
