  ...
  Hauptseiten: [
    {
      ...
      url: "/",
      description:
        "Willkommen bei M&M Reifenservice - Ihr Reifenexperte in Essen",
    },
    {
      name: "Services",
      url: createPageUrl("Services"),
      description:
        "Alle unsere Reifenservices: Wechsel, Auswuchten, Reparatur und Einlagerung",
    },
    {
      name: "Reifenbestand",
    ...
    },
    {
      ...
      description: "Nehmen Sie Kontakt zu uns auf",
    },
    {
      name: "Über uns",
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            >
              ...
              <ul className="space-y-4">
                {pages.map((page, index) => (
                  <li key={index}>
                    <Link to={page.url} className="group block">
                      <h3
                        className={`text-lg font-semibold group-hover:text-[#d9002d] transition-colors mb-1`}
        ...
        >
          ...
          <p className="text-lg mb-6">Nehmen Sie kontakt zu uns auf!</p>
