      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <div className="space-y-8" style={{ color: MEDIUM_COLOR }}>
            ...
            <div className={`rounded-xl p-6`} style={{ backgroundColor: LIGHT_BG + '0F' }}>
              ...
              <div className="space-y-2">
                ...
                <p>
                  ...
                  <a href={`mailto:${EMAIL}`} className={`hover:underline ml-1`} style={{ color: ACCENT_COLOR }}>
                    {EMAIL}
                  </a>
                </p>
              </div>
            ...
            <div className={`rounded-xl p-6`} style={{ backgroundColor: LIGHT_BG + '0F' }}>
              <h2 className={`text-2xl font-bold mb-4`} style={{ color: DARK_COLOR }}>Umsatzsteuer-ID</h2>
              <p>
            ...
            <div className={`rounded-xl p-6`} style={{ backgroundColor: LIGHT_BG + '0F' }}>
              <h2 className={`text-2xl font-bold mb-4`} style={{ color: DARK_COLOR }}>EU-Streitschlichtung</h2>
              <p>
                Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit: 
                <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className={`hover:underline ml-1`} style={{ color: ACCENT_COLOR }}>
            ...
            <div className={`rounded-xl p-6`} style={{ backgroundColor: LIGHT_BG + '0F' }}>
              <h2 className={`text-2xl font-bold mb-4`} style={{ color: DARK_COLOR }}>Verbraucherstreitbeilegung</h2>
              <p>
            ...
            <div className={`rounded-xl p-6`} style={{ backgroundColor: LIGHT_BG + '0F' }}>
              <h2 className={`text-2xl font-bold mb-4`} style={{ color: DARK_COLOR }}>Haftungsausschluss</h2>
              <h3 className={`text-lg font-bold mb-2`} style={{ color: DARK_COLOR }}>Haftung für Inhalte</h3>
              <p className="mb-4">
              ...
              <h3 className={`text-lg font-bold mb-2`} style={{ color: DARK_COLOR }}>Haftung für Links</h3>
              <p>
